 ...
 * Keywords: banks, payment methods, supported
 */
?>
<!-- wp:group {"className":"section-banks animate-on-scroll","layout":{"type":"constrained"}} -->
<div class="wp-block-group section-banks animate-on-scroll"><!-- wp:columns {"className":"fpay-bank-grid"} -->
<div class="wp-block-columns fpay-bank-grid"><!-- wp:column {"className":"fpay-bank-col"} -->
<div class="wp-block-column fpay-bank-col"><!-- wp:paragraph {"align":"center","className":"fpay-bank-header yellow"} -->
<p class="has-text-align-center fpay-bank-header yellow">VIETNAM</p>
<!-- /wp:paragraph --><!-- wp:list {"className":"fpay-bank-list"} -->
<ul class="wp-block-list fpay-bank-list"><!-- wp:list-item -->
...
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --><!-- wp:column {"className":"fpay-bank-col"} -->
<div class="wp-block-column fpay-bank-col"><!-- wp:paragraph {"align":"center","className":"fpay-bank-header blue"} -->
<p class="has-text-align-center fpay-bank-header blue">INDONESIA</p>
<!-- /wp:paragraph --><!-- wp:list {"className":"fpay-bank-list"} -->
<ul class="wp-block-list fpay-bank-list"><!-- wp:list-item -->
...
<!-- /wp:list --></div>
<!-- /wp:column --><!-- wp:column {"className":"fpay-bank-col"} -->
<div class="wp-block-column fpay-bank-col"><!-- wp:paragraph {"align":"center","className":"fpay-bank-header red"} -->
<p class="has-text-align-center fpay-bank-header red">MALAYSIA</p>
<!-- /wp:paragraph --><!-- wp:list {"className":"fpay-bank-list"} -->
<ul class="wp-block-list fpay-bank-list"><!-- wp:list-item -->
...
<!-- /wp:list --></div>
<!-- /wp:column --><!-- wp:column {"className":"fpay-bank-col"} -->
<div class="wp-block-column fpay-bank-col"><!-- wp:paragraph {"align":"center","className":"fpay-bank-header navy"} -->
<p class="has-text-align-center fpay-bank-header navy">THAILAND</p>
<!-- /wp:paragraph --><!-- wp:list {"className":"fpay-bank-list"} -->
<ul class="wp-block-list fpay-bank-list"><!-- wp:list-item -->
